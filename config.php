...
const QUANTITY_OF_PRECIPITATION_FOR_DETECT_LAST_RAINING = 2;

// Delay min since last raining day to allow the today watering :
const DELAY_SINCE_LAST_RAINING = 3;

// Delay min since last watering to allow the today watering :
const DELAY_SINCE_LAST_WATERING = 3;
